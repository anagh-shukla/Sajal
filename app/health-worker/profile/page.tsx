...
import { ArrowLeft, Stethoscope, Save, Edit, Eye, EyeOff } from "lucide-react"
...
export default function HealthWorkerProfile() {
  ...
  const [formData, setFormData] = useState({
    ...
    area: "HSR Layout Block",
    phone: "+91 98765 43210",
    email: "priya.sharma@health.gov.in",
    userId: "HSR_PRIYA_001",
    password: "********",
  })
  ...
  const handleSave = () => {
    console.log("[v0] Saving health worker profile data:", formData)
    setIsEditing(false)
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>Your professional information and work details</CardDescription>
              </div>
              <Button
